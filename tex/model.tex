...
\begin{align}
    ...
    &\forall e=(u,v) \in \V \colon \forall w \in \Wmc \colon \forall t \in \T
...
To force a collision, we use the following constraints to fix the values of some decision
variables.
\begin{align}
...
\TODO{Maybe }
\begin{figure}[h]
    \missingfigure{draw a figure showing the collision we avoid, using these
    constraints}
    \caption{This kind of movement will cause collision.}
    \label{fig:orthcol}
\end{figure}
...
\end{align}
Now we can finally give the constraints.
