...
city density, more complex technological solutions can be used to rectify it. One of possible
...
addressed in this work using integer programming models, that can be solved
using off-the-shelf solvers. We look at a specific possible implementation of
automated valet parking and successfully design an integer programming model to
...
keerulisem probleem, muutub selle kõrgtehnoloogiline lahendamine
...
mudeleid, mida saab lahendada juba eksisteerivate lahendajatega.
Käesolevas töös käsitletakse ühte kindlat võimalikku automaatparkla
implementatsiooni ja edukalt tuletatakse täisarvulise planeerimise mudel selle
...
lahendajat leiti optimaalne lahendus näidisjuhtude jaoks. Mudelit võrreldi
teise täisarv planeerimise mudeliga algoritmide ja teooria teadusgrupist, mis
andis kindlust ja võrdlusmaterjali mudeli toimimisele.

\vspace*{3ex}
{\flushleft{\textbf{Võtmesõnad:} täisarvuline planeerimine
