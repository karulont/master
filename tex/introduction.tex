...
We let $K$ be the number of different labels we want to give to cars. We do not
give robots labels, because for our simplification, they are indistinguishable.
Every parking space has status. All possible node statuses are described
...
in~\cite{calinescu2008reconfigurations}. For this tought experiment, we further simplify our problem, and also forget about robots and the times. 
